...
class PVN3DLoss(nn.Module):
    """Keypoint voting loss for PVN3D."""
    ...
    def forward(
        ...
        **kwargs
        ...
        kp_offsets = pred_dict['kp_offsets']  # [B, N, K, 3]
        ctr_offsets = pred_dict['ctr_offsets']  # [B, N, 3]
        sem_logits = pred_dict.get('sem_logits')
        
        B, N, K, _ = kp_offsets.shape
        
        # Compute GT offsets if targets and points provided
